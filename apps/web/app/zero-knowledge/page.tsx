    ...
    <>
      ...
      <main id="main-content" className="min-h-dvh bg-background font-sans text-foreground">
        ...
        <FaqSection
          ...
          intro="Pulled from real conversations with security-conscious professionals who need verifiable privacy."
        />
        ...
        <FinalCTA
          ...
          subtitle="3-day free trial. No credit card. In local mode your voice stays on your device from day one. Pay once, use forever."
        />
