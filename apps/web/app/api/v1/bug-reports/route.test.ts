...
let app: ReturnType<typeof createVoicetyprApi>;
...
function createRequest(body: unknown, headers: Record<string, string> = {}) {
  return new Request('https://voicetypr.com/api/v1/bug-reports', {
    method: 'POST',
    headers: {
...
describe('POST /api/v1/bug-reports', () => {
  ...
  it('responds to OPTIONS with CORS headers', async () => {
    const response = await app.request('https://voicetypr.com/api/v1/bug-reports', {
      method: 'OPTIONS',
    });
