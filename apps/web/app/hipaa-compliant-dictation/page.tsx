    ...
    <>
      ...
      <main id="main-content" className="min-h-dvh bg-background font-sans text-foreground">
        ...
        <FaqSection
          ...
          intro="Pulled from real conversations with therapists, doctors, and practice managers who need secure dictation."
        />
        ...
        <FinalCTA
          ...
          subtitle="3-day free trial. No credit card. Local transcription on your device from day one. Pay once, use forever."
        />
