        ...
        {result ? (
          <div className="space-y-4">
            <div>
              ...
              <div aria-live="polite" className="mt-1 text-[34px] font-semibold tracking-tight text-foreground">
                {formatMinutes(result.minutesSavedPerDay)}
              </div>
            </div>
            <div className="grid gap-3 text-[14px] text-muted-foreground">
          ...
          <p className="text-[14px] text-muted-foreground">Enter valid numbers to see your estimate.</p>
        )}
      </div>
    </div>
  );
