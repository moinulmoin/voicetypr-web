  ...
  return (
    <section className="ed-section !pb-10">
      <div className="ed-container">
        <div className="bg-editorial-surface-2 px-6 py-8 md:px-8 md:py-10 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[1fr_22rem] lg:items-end">
            ...
            <div>
              <div className="bg-white p-4">
                <div className="rounded-md bg-editorial-ink px-3 py-2 text-sm text-white">
                  Draft this into a cleaner reply.
                </div>
                <div className="mt-3 rounded-md bg-editorial-surface-2 px-3 py-2 text-sm leading-relaxed text-editorial-ink-2">
                  Done — pasted where your cursor already is.
                </div>
              </div>
              ...
              <div className="mt-5 flex flex-wrap gap-x-4 gap-y-2 text-xs uppercase tracking-widest text-editorial-ink-3">
                {proofItems.map((item) => (
